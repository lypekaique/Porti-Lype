  ...
  return (
    <div className="flex flex-col justify-start items-start w-full p-0 mt-10">
      ...
      >
        ...
        >
          <p className="text-[3.5rem] font-semibold m-0">GitHub</p>
          <svg
            viewBox="0 0 48 48"
            fill="none"
        ...
        >
          <p className="text-[3.5rem] font-semibold m-0">Linkedin</p>
          <svg
            viewBox="0 0 48 48"
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
        ...
        >
          <p className="text-[3.5rem] font-semibold black m-0">Twitter</p>
          <svg
            viewBox="0 0 48 48"
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
        ...
        >
          {" "}
          <p className="text-[3.5rem] font-semibold m-0">Facebook</p>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            x="0px"
            y="0px"
